...
**Date:** 2026-05-28
**Issue:** [#41](https://github.com/techempower-org/familiar.realm.watch/issues/41) — *Validate reranker model choice against True Memory ablation findings*
...
- Whether *the next reranker* should be a different rerank backend entirely (e.g., a Pascal-GPU-served cross-encoder, a `rank_zephyr` LLM-rerank on a colocated llama.cpp). Out of scope for #41.
