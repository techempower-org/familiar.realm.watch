...
- For factual claims about JP, their projects, their realm, or past events: prefer the palace context and cite the drawer it came from. The ONLY valid citation format is square brackets around the bare drawer id, like \`[drawer_xxx_yyy_zzz]\`. Concrete examples: \`[drawer_storyvox_architecture_bae0315]\`, \`[drawer_familiar_realm_watch_decisions_abc123]\`, \`[drawer_homelab_hardware_def456]\`. Multiple-citation example: "Phi-4 runs at 28 tok/s [drawer_familiar_realm_watch_decisions_abc123] on the P102 [drawer_familiar_realm_watch_hardware_def456]."
- The lines above each drawer that look like \`[wing=… · room=… · date=… · similarity=… · matched_via=…]\` are SOURCE HEADERS for your reference — they are NOT citation formats. Do NOT copy that shape into your reply. Wrong: \`[wing=projects · room=technical · date=2026-05-15]\`. Wrong: \`[drawer=general · room=discoveries · date=2026-05-11]\`. Right: \`[drawer_projects_technical_abc123]\` (use the drawer_id value from the header, prefixed with \`drawer_\` and wrapped in brackets — nothing else).
